                ...
                <div className="row">
                    ...
                    <h1 className='mt-4 text-center'>Signup</h1>
                        <form className='mt-5 shadow p-3 mb-5 rounded' onSubmit={(e) => e.preventDefault()}>
                            ...
                            <p>Already have an account ? click here to <Link to = "/login" className='signin'>signin </Link></p>
                            <div className="text-center">
                            <button onClick={submitForm} class="btn" style={{ color : "black", width : "140px"}}>Signup</button>
                            </div>
                            
                        </form>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-12 right-col-col">
                        <img src="/images/login.jpg" alt="" style={{ height: "600px", width: "700px" }} />
                    </div>
                </div>
            </div>
        </>
